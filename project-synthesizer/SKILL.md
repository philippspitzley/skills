...
description: Synthesizes a planning conversation into the Six-File Context System. Use when a project architecture conversation concludes and the user wants to generate the final context documentation.
---
...
4. [Code Standards Template](./templates/context/code-standards.md) -> `context/code-standards.md`
5. [AI Workflow Rules Template](./templates/context/ai-workflow-rules.md) -> `context/ai-workflow-rules.md`
6. [Progress Tracker Template](./templates/context/progress-tracker.md) -> `context/progress-tracker.md`
7. [AGENTS.md Template](./templates/AGENTS.md) -> `AGENTS.md` (in the root directory)
